...
var LoadConfigEffects = /** @class */ (function () {
    function LoadConfigEffects(actions$, router, configService) {
        ...
        this.getConfigs$ = this.actions$
            ...
            .switchMap(function (data) { return _this.configService.getConfigs(); })
            .map(function (configs) { return new actions_1.ConfigLoadedSucceedAction(configs); })
            .catch(function () { return Observable_1.Observable.of(new actions_1.ConfigLoadedFailedAction()); });
    }
    __decorate([
        effects_1.Effect(),
        __metadata("design:type", Object)
    ], LoadConfigEffects.prototype, "getConfigs$", void 0);
    LoadConfigEffects = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [effects_1.Actions, router_1.Router, services_1.ConfigService])
    ], LoadConfigEffects);
